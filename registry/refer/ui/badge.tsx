...
const badgeVariants = cva(
  "inline-flex items-center justify-center rounded-full border cursor-default px-[9px] py-[5px] has-[>svg]:pl-2 text-xs font-medium leading-none w-fit whitespace-nowrap shrink-0 [&>svg]:size-3 gap-1 [&>svg]:pointer-events-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive transition-[color,box-shadow] overflow-hidden",
  {
    variants: {
      variant: {
        primary:
        ...
        secondary_subtle:
          "border border-border-low bg-muted text-foreground/80 [a&]:hover:bg-foreground/20",
        destructive:
