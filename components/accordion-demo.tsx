import {
  ...
  AccordionItem,
  AccordionTrigger,
} from "@/registry/refer/ui/accordion"
...
export function AccordionDemo() {
  return (
    <div className="grid w-full max-w-xl gap-4">
      ...
      <Accordion type="single" collapsible className="w-full">
        <AccordionItem value="item-1">
          <AccordionTrigger iconPosition="start">Is it accessible?</AccordionTrigger>
          <AccordionContent>
            Yes. It adheres to the WAI-ARIA design pattern.
          </AccordionContent>
        </AccordionItem>
        <AccordionItem value="item-2">
          <AccordionTrigger iconPosition="start">Is it styled?</AccordionTrigger>
          <AccordionContent>
            Yes. It comes with default styles that matches the other
            components&apos; aesthetic.
          </AccordionContent>
        ...
        <AccordionItem value="item-3">
          <AccordionTrigger iconPosition="start">Is it animated?</AccordionTrigger>
          <AccordionContent>
            Yes. It&apos;s animated by default, but you can disable it if you
            prefer.
          </AccordionContent>
